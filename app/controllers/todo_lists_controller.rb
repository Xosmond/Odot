class TodoListsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @todo_list.save
        format.html { redirect_to @todo_list, notice: 'La lista ha sido creada satisfactoriamente.' }
  ...
  def update
    respond_to do |format|
      if @todo_list.update(todo_list_params)
        format.html { redirect_to @todo_list, notice: 'La lista ha sido actualizada satisfactoriamente.' }
